FROM rabbitmq:3.9.15-management-alpine AS base
...
COPY --from=build $RABBITMQ_HOME/plugins/rabbitmq_delayed_message_exchange-3.9.0.ez $RABBITMQ_HOME/plugins/rabbitmq_delayed_message_exchange-3.9.0.ez
